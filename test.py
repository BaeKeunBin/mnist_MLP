...
hiddendim=64    #hiddenLayer node count
outputdim=10    #outputLayrt node count


#for i in range(0,hiddendim):    # hiddenLayer*inputLyer 의 수만큼 weight 생성
#    initweight = np.zeros(784)  #초기 weight = 0
#    wji.append(initweight)
#    
#for i in range(0,outputdim):    #outputLayer * hiddenLayer 의 수만큼 weight 생성
#    initweight = np.zeros(hiddendim)
#    wkj.append(initweight)
